                    ...
                    <div class="in-check" >
                        ...
                        @foreach(\App\Helper\sepetHelper::allList() as $key =>$value)
                            <ul class="cart-header">
                                ...
                                <li class="ring-in">
                                    <img style="width: 100px; height: 100px;" src="{{$value['image']}}" class="img-responsive" alt=""> <!-- bu kısımda sepet görüntüsü çağırıldı-->
                                </li>
                                <li><span class="name">{{$value['name']}}</span></li> <!-- bu kısımda sepet adı çağırıldı-->
