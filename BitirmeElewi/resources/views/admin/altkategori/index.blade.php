                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($data as $key => $value)
                                            <tr>
                                                ...
                                                <td>{{$value['AltKategoriAdi']}}</td>
                                                <td><a href="{{route('admin.altkategori.edit',['id'=>$value['AltKategoriID']])}}">Düzenle</a></td>
                                                <td><a href="{{route('admin.altkategori.delete',['id'=>$value['AltKategoriID']])}}">Sil</a></td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
